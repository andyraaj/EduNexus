...
type ContactRole = 'faculty' | 'admin';
...
const StudentMessagesPage: React.FC = () => {
        ...
        const load = async () => {
            ...
            try {
                const [facultyRes, adminRes] = await Promise.all([
                    fetchUsers(accessToken, { role: 'faculty', limit: 100 }),
                    fetchUsers(accessToken, { role: 'admin', limit: 100 }),
                ]);
                setContacts([...facultyRes.users, ...adminRes.users]);
            } catch (e: any) {
    ...
    const roleTag = (role: string) =>
        role === 'faculty' ? styles.tagFaculty : styles.tagAdmin;
        ...
        <div style={styles.page}>
            ...
            <div style={styles.pageHeader}>
                <div>
                    ...
                    <p style={styles.subtitle}>Chat with your faculty and admin staff</p>
                </div>
                ...
                <aside style={styles.sidebar}>
                    ...
                    <div style={styles.sidebarTop}>
                        ...
                        <div style={styles.filterRow}>
                            {(['all', 'faculty', 'admin'] as const).map(r => (
                                <button
                                    key={r}
                    ...
                    {activeContact ? (
                        ...
                        <div style={styles.noChatState}>
                            ...
                            <p style={styles.noChatSub}>
                                Choose a faculty member or admin from the list to open a conversation.
                            </p>
                        </div>
                    )}
                </main>
...
const styles: Record<string, React.CSSProperties> = {
    page: {
        ...
        height: 'calc(100vh - 64px)',      // fill under header
        padding: '1.5rem',
        gap: '1rem',
    ...
    tagFaculty: { background: '#dbeafe', color: '#1d4ed8' },
